...
INTENT_MEMORY_SCHEMA = "stevecad-intent-memory-v1"
...
def validate_memory(raw: Any, *, project_id: str) -> dict[str, Any]:
    ...
    if stored_project_id != str(project_id):
        raise RuntimeError(
            "Intent Memory belongs to a different SteveCAD project: "
...
def render_design_markdown(memory: dict[str, Any]) -> str:
    lines = [
        "<!-- Generated by SteveCAD Intent Memory. Do not edit manually. -->",
        "# SteveCAD Design Intent",
        "",
    ]
    active = [
