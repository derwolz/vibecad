...
COMPILER_INSTRUCTIONS = """You maintain SteveCAD Intent Memory.
    ...
    *,
    ...
    try:
        ...
        thread_request: dict[str, Any] = {
            ...
            "serviceName": "stevecad-intent-memory",
        }
        if clean_provider in {"openai", "grok"}:
...
def compile_intent_memory_update(
    *,
    ...
    result = _run_provider_subprocess(
        ...
        provider_label="SteveCAD Intent Memory compiler",
    )
