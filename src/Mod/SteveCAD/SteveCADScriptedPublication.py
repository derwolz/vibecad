...
PROP_ROLE = "SteveCADScriptedRole"
PROP_ENGINE = "SteveCADScriptedEngine"
PROP_MODEL_ID = "SteveCADScriptedModelId"
PROP_OUTPUT_KEY = "SteveCADScriptedOutputKey"
PROP_REVISION = "SteveCADPublishedRevision"
PROP_IMPLEMENTATION = "SteveCADImplementationObject"
PROP_INTERFACES = "SteveCADPublishedInterfaces"
PROP_PARAMETER_NAMES = "SteveCADParameterNames"
...
def ensure_string_property(obj: Any, name: str) -> None:
    if name not in list(getattr(obj, "PropertiesList", []) or []):
        obj.addProperty("App::PropertyString", name, "SteveCAD Publication")
