...
_SIMULATION_TRACE_SCHEMA = "stevecad-assembly-simulation-trace-v1"
_MAX_SIMULATION_TRACE_BYTES = 64 * 1024 * 1024
_EXPLODED_VIEW_SCHEMA = "stevecad-assembly-exploded-view-v1"
_ASSEMBLY_BOM_SCHEMA = "stevecad-assembly-bom-v1"
_ASSEMBLY_HIERARCHY_SCHEMA = "stevecad-assembly-source-hierarchy-v1"
...
def _catalog_fastener_source(
    ...
    from SteveCADFasteners import catalog_component_reference
...
def _bom_component_sources(
    ...
    for value in component_values:
        ...
        if value.operation == "fastener":
            ...
            from SteveCADFasteners import fastener_bom_properties
...
def _execute_native_bom(
    *,
    ...
    from SteveCADAssemblyBOM import (
        ASSEMBLY_BOM_SCHEMA,
        AssemblyBOMError,
        plan_assembly_bom,
    )
...
def validate_and_solve_assembly(
    ...
    if bom_contract:
        from SteveCADAssemblyBOM import bom_summary
