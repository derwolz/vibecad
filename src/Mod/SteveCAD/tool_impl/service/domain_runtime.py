...
"""Workbench/domain read-tool implementations outside ``SteveCADCore``."""
...
def _mark_timeline_operation(operation: Any) -> None:
    ...
    if "SteveCADTimelineOwner" in operation.PropertiesList:
        ...
        operation.setEditorMode("SteveCADTimelineOwner", 2)
...
def partdesign_operation_for_feature(feature: Any) -> str | None:
    ...
    if (
        ...
        and str(getattr(feature, "SteveCADFeatureType", "")) == "thin_loft"
    ):
        return "thin_loft"
