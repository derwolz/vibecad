...
from stevecad_tests.native_sketch_equal_gui_case import (
    exercise_equal_case,
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = Path(tempfile.mkdtemp(prefix="stevecad-native-sketch-equal-")) / (
        ...
        print(
            "STEVECAD_NATIVE_SKETCH_EQUAL_GUI_OK "
