...
def _phase(name: str) -> None:
    os.write(2, f"STEVECAD_NATIVE_SKETCH_SYMMETRY_PHASE {name}\n".encode("ascii"))
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = Path(tempfile.mkdtemp(prefix="stevecad-native-symmetry-")) / (
        ...
        _phase("complete")
        print(
            "STEVECAD_NATIVE_SKETCH_SYMMETRY_GUI_OK "
