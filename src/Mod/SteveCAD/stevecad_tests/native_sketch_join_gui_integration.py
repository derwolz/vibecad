...
from stevecad_tests.native_sketch_join_gui_case import (
    exercise_join_case,
...
def _phase(name: str) -> None:
    os.write(2, f"STEVECAD_NATIVE_SKETCH_JOIN_PHASE {name}\n".encode())
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = Path(tempfile.mkdtemp(prefix="stevecad-native-join-")) / (
        ...
        _phase("complete")
        print(
            "STEVECAD_NATIVE_SKETCH_JOIN_GUI_OK "
