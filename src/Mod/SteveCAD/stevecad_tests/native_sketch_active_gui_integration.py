...
from stevecad_tests.native_sketch_active_gui_case import (
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = (
            Path(tempfile.mkdtemp(prefix="stevecad-native-sketch-active-"))
        ...
        print(
            "STEVECAD_NATIVE_SKETCH_ACTIVE_GUI_OK "
