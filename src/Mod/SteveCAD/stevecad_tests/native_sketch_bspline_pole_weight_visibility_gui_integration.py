...
def _phase(name: str) -> None:
    os.write(2, f"STEVECAD_NATIVE_SKETCH_BSPLINE_WEIGHT_VIEW_PHASE {name}\n".encode())
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = (
            Path(tempfile.mkdtemp(prefix="stevecad-native-bspline-weight-view-"))
        ...
        _phase("complete")
        print(
            "STEVECAD_NATIVE_SKETCH_BSPLINE_WEIGHT_VIEW_GUI_OK "
