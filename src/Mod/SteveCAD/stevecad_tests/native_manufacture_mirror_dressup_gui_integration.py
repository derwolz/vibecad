...
def _run() -> None:
    ...
    exit_code = 1
    try:
        temporary = tempfile.TemporaryDirectory(prefix="stevecad-native-mirror-")
        ...
        with patch(
            "SteveCADNativeManufactureModifyRuntime.verify_created_mirror_dressup",
        ...
        print(
            "STEVECAD_NATIVE_MANUFACTURE_MIRROR_DRESSUP_GUI_OK "
