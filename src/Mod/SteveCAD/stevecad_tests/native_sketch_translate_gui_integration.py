...
from stevecad_tests.native_sketch_translate_gui_case import (
...
def _phase(name: str) -> None:
    os.write(2, f"STEVECAD_NATIVE_SKETCH_TRANSLATE_PHASE {name}\n".encode("ascii"))
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = Path(tempfile.mkdtemp(prefix="stevecad-native-translate-")) / (
        ...
        _phase("complete")
        print(
            "STEVECAD_NATIVE_SKETCH_TRANSLATE_GUI_OK "
