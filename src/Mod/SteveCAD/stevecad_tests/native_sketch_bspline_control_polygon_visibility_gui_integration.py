...
def _phase(name: str) -> None:
    os.write(2, f"STEVECAD_NATIVE_SKETCH_BSPLINE_POLYGON_PHASE {name}\n".encode())
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = (
            Path(tempfile.mkdtemp(prefix="stevecad-native-bspline-polygon-"))
        ...
        _phase("complete")
        print(
            "STEVECAD_NATIVE_SKETCH_BSPLINE_POLYGON_GUI_OK "
