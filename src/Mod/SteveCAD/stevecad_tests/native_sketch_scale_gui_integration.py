...
from stevecad_tests.native_sketch_scale_gui_case import (
    exercise_scale_case,
...
def _phase(name: str) -> None:
    os.write(2, f"STEVECAD_NATIVE_SKETCH_SCALE_PHASE {name}\n".encode("ascii"))
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = Path(tempfile.mkdtemp(prefix="stevecad-native-scale-")) / (
        ...
        _phase("complete")
        print(
            "STEVECAD_NATIVE_SKETCH_SCALE_GUI_OK "
