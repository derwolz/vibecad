...
AERO_TAB_LABEL = "Aero"
AERO_GROUP_OBJECT_NAME = "SteveCADRibbonGroup_Aero"
AERO_TAB_DATA = "SteveCADAeroWorkbench"
PARAMETERS_TAB_LABEL = "Parameters"
RIBBON_TABS_OBJECT_NAME = "SteveCADRibbonTabs"
RIBBON_PAGE_OBJECT_NAME = "SteveCADRibbonPage"
RIBBON_GROUP_PREFIX = "SteveCADRibbonGroup_"
AERO_BUTTONS = (
...
_INSTALLED_PROPERTY = "_stevecadAeroRibbonInstalled"
...
def _ensure_aero_commands(gui: Any | None = None) -> None:
    ...
    aero_dir = Path(__file__).resolve().parent.parent / "SteveCADAero"
    if not aero_dir.is_dir():
        raise RuntimeError(f"SteveCAD Aero module directory is missing: {aero_dir}")
