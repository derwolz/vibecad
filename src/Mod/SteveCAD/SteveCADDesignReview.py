...
REVIEW_INSTRUCTIONS = """You are SteveCAD's independent principal mechanical design reviewer.
    ...
    *,
    ...
    try:
        ...
        thread_request: dict[str, Any] = {
            ...
            "serviceName": "stevecad-design-review",
        }
        if clean_provider in {"openai", "grok"}:
...
def run_design_review(
    *,
    ...
    result = _run_provider_subprocess(
        ...
        provider_label="SteveCAD design reviewer",
    )
