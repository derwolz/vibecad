...
The native Aero domain presents its commands through the standard SteveCAD
...
_HOST_NAME = "SteveCADAeroWorkspaceHost"
_WIDGET_NAME = "SteveCADAeroWorkspace"
_VEHICLE_LABELS = (
    ("airplane", "Airplane"),
...
def _ensure_widget() -> AeroWorkspaceWidget | None:
    ...
    dock.setObjectName("SteveCADAeroDock")
        ...
        class _Widget(QtWidgets.QWidget):
            ...
            def _build(self) -> None:
                ...
                for index, (key, title) in enumerate(items):
                    ...
                    value.setObjectName(f"SteveCADAeroResult_{key}")
