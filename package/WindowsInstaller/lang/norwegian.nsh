...
${LangFileString} TEXT_WELCOME "Denne veiviseren installerer SteveCAD på datamaskinen din.$\r$\n\
				$\r$\n\
				$_CLICK"
...
${LangFileString} SecCoreDescription "SteveCAD-filene."
#${LangFileString} SecAllUsersDescription "Installer SteveCAD for alle brukere, eller kun for denne brukeren."
${LangFileString} SecFileAssocDescription "Filer med endelsen .FCStd åpnes automatisk i SteveCAD."
...
#${LangFileString} ConfigInfo "Konfigurasjon av SteveCAD vil ta en stund."
...
${LangFileString} AlreadyInstalled "SteveCAD ${APP_SERIES_KEY2} er allerede installert!$\r$\n\
				...
				I slike tilfeller er det bedre å reinstallere SteveCAD.$\r$\n\
				Vil du likevel installere SteveCAD over den eksisterende versjonen?"
${LangFileString} NewerInstalled "Du prøver å installere en eldre versjon av SteveCAD enn den du har installert fra før.$\r$\n\
				  Dersom du ønsker dette må du avinstallere SteveCAD $OldVersionNumber først."

#${LangFileString} FinishPageMessage "Gratulerer!! SteveCAD er installert.$\r$\n\
#					$\r$\n\
#					(Første gangs oppstart av SteveCAD kan ta noen sekunder.)"
${LangFileString} FinishPageRun "Start SteveCAD"

${LangFileString} UnNotInRegistryLabel "Fant ikke SteveCAD i registeret.$\r$\n\
					Snarveier på skrivebordet og i startmenyen fjernes ikke."
${LangFileString} UnInstallRunning "Du må avslutte SteveCAD først!"
${LangFileString} UnNotAdminLabel "Du må ha administratorrettigheter for å fjerne SteveCAD!"
${LangFileString} UnReallyRemoveLabel "Er du sikker på at du vil fjerne SteveCAD og alle tilhørende komponenter?"
${LangFileString} UnFreeCADPreferencesTitle 'SteveCAD sine bruker innstillinger'

#${LangFileString} SecUnProgDescription "Avinstallerer xxx."
${LangFileString} SecUnPreferencesDescription 'Sletter SteveCAD sine konfigurasjonsmapper$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
						for alle brukere.'
...
${LangFileString} SecUnProgramFilesDescription "Avinstallerer SteveCAD og alle delkomponenter."
