...
${LangFileString} TEXT_WELCOME "Este assistente de instalação irá guiá-lo através da instalação do SteveCAD.$\r$\n\
				$\r$\n\
				$_CLICK"
...
${LangFileString} SecCoreDescription "Os ficheiros SteveCAD."
#${LangFileString} SecAllUsersDescription "Instalar o SteveCAD para todos os utilizadores ou apenas para o presente utilizador."
${LangFileString} SecFileAssocDescription "Os ficheiros com a extensão .FCStd irão abrir automaticamente no SteveCAD."
${LangFileString} SecDesktopDescription "Um icone do SteveCAD no ambiente de trabalho."
...
#${LangFileString} ConfigInfo "A configuração seguinte do SteveCAD irá demorar um bocado."
...
${LangFileString} AlreadyInstalled "O SteveCAD ${APP_SERIES_KEY2} já está instalado!$\r$\n\
				...
				Nestes casos é melhor reinstalar o SteveCAD$\r$\n\
				Quer continuar na mesma a instalar o SteveCAD sobre a versão existente?"
${LangFileString} NewerInstalled "Está a tentar instalar uma versão mais antiga do que a que tem instalada.$\r$\n\
				  Se realmente quer fazer isto deve antes desinstalar o SteveCAD $OldVersionNumber."

#${LangFileString} FinishPageMessage "Parabéns! O SteveCAD foi instalado com sucesso.$\r$\n\
#					$\r$\n\
#					(O primeiro início do SteveCAD pode levar alguns segundos.)"
${LangFileString} FinishPageRun "Lançar o SteveCAD"

${LangFileString} UnNotInRegistryLabel "Incapaz de encontrar o SteveCAD no registry.$\r$\n\
					Os atalhos para o ambiente de trabalho no menu Start não serão removidos."
${LangFileString} UnInstallRunning "Deve fechar o SteveCAD em primeiro lugar!"
${LangFileString} UnNotAdminLabel "Precisa de privilégios de administrador para desinstalar o SteveCAD!"
${LangFileString} UnReallyRemoveLabel "Tem a certeza que quer remover completamente o SteveCAD e todas as suas componentes?"
${LangFileString} UnFreeCADPreferencesTitle 'Preferências de utilizador do SteveCAD'

#${LangFileString} SecUnProgDescription "Desinstala xxx."
${LangFileString} SecUnPreferencesDescription 'Apaga as pastas de configuração do  SteveCAD$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Desinstala SteveCAD e todas as suas componentes."
