...
${LangFileString} TEXT_WELCOME "Kreator przeprowadzi Ciebie przez proces instalacji SteveCAD$\'a.$\r$\n\
				$\r$\n\
				$_CLICK"
...
#${LangFileString} FileTypeTitle "Dokument SteveCAD"
...
${LangFileString} SecCoreDescription "Pliki SteveCAD$\'a."
#${LangFileString} SecAllUsersDescription "Instalacja dla wszystkich użytkowników lub tylko dla bieżącego użytkownika."
${LangFileString} SecFileAssocDescription "Skojarzenie SteveCAD-a z plikami o rozszerzeniu .FCStd."
${LangFileString} SecDesktopDescription "Ikona SteveCAD$\'a na pulpicie."
...
#${LangFileString} ConfigInfo "Dalsza konfiguracja SteveCAD$\'a chwilę potrwa."
...
${LangFileString} AlreadyInstalled "SteveCAD ${APP_SERIES_KEY2} jest już zainstalowany!$\r$\n\
...
${LangFileString} NewerInstalled "Próbujesz zainstalować starszą wersję SteveCAD, niż ta która jest już zainstalowana.$\r$\n\
				  Jeżeli naprawdę chcesz tego dokonać, musisz wpierw odinstalować SteveCAD $OldVersionNumber."

#${LangFileString} FinishPageMessage "Gratulacje! SteveCAD został pomyślnie zainstalowany.$\r$\n\
#					$\r$\n\
#					(Pierwsze uruchomienie może potrwać kilka sekund.)"
${LangFileString} FinishPageRun "Uruchom SteveCAD"

${LangFileString} UnNotInRegistryLabel "Nie można znaleźć SteveCAD$\'a w rejestrze.$\r$\n\
					Skróty na pulpicie i w menu Start nie zostaną usunięte."
${LangFileString} UnInstallRunning "Musisz najpierw zamknąć SteveCAD$\'a!"
${LangFileString} UnNotAdminLabel "Musisz posiadać prawa administratora do deinstalacji programu SteveCAD."
${LangFileString} UnReallyRemoveLabel "Czy na pewno chcesz usunąć SteveCAD$\'a i wszystkie jego komponenty?"
${LangFileString} UnFreeCADPreferencesTitle 'Preferencje użytkownika SteveCAD$\'a'

#${LangFileString} SecUnProgDescription "Deinstalacja xxx."
${LangFileString} SecUnPreferencesDescription 'Usuwa folder konfiguracji SteveCAD$\'a$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Deinstalacja SteveCAD i wszystkich jego komponentów."
