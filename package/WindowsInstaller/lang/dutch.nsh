...
${LangFileString} TEXT_WELCOME "Dit installatie programma zal SteveCAD op uw systeem installeren.$\r$\n\
				$\r$\n\
				$_CLICK"
...
${LangFileString} SecCoreDescription "De SteveCAD bestanden."
#${LangFileString} SecAllUsersDescription "Installeer SteveCAD voor alle gebruikers of uitsluitend de huidige gebruiker?"
${LangFileString} SecFileAssocDescription "Associeer het SteveCAD programma met de .FCStd extensie."
${LangFileString} SecDesktopDescription "Een SteveCAD pictogram op het Bureaublad."
...
#${LangFileString} ConfigInfo "De volgende configuratie van SteveCAD zal enige tijd duren."
...
${LangFileString} AlreadyInstalled "SteveCAD ${APP_SERIES_KEY2} is reeds geinstalleerd!$\r$\n\
...
#${LangFileString} FinishPageMessage "Gefeliciteerd! SteveCAD is succesvol geinstalleerd.$\r$\n\
#					$\r$\n\
#					(De eerste keer dat u SteveCAD start kan dit enige seconden duren.)"
${LangFileString} FinishPageRun "Start SteveCAD"

${LangFileString} UnNotInRegistryLabel "SteveCAD is niet gevonden in het Windows register.$\r$\n\
					Snelkoppelingen op het Bureaublad en in het Start Menu worden niet verwijderd."
${LangFileString} UnInstallRunning "U moet SteveCAD eerst afsluiten!"
${LangFileString} UnNotAdminLabel "U heeft systeem-beheerrechten nodig om SteveCAD te verwijderen!"
${LangFileString} UnReallyRemoveLabel "Weet u zeker dat u SteveCAD en alle componenten volledig wil verwijderen van deze computer?"
${LangFileString} UnFreeCADPreferencesTitle 'SteveCAD$\'s user preferences'

#${LangFileString} SecUnProgDescription "Verwijder xxx."
${LangFileString} SecUnPreferencesDescription 'Verwijder SteveCAD$\'s configuratie map$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Verwijder SteveCAD en alle bijbehorende onderdelen."
