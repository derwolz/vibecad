...
${LangFileString} TEXT_WELCOME "Este asistente vai-no guiar na instalación do SteveCAD no seu computador.$\r$\n\
				$\r$\n\
				$_CLICK"
...
#${LangFileString} SecAllUsersDescription "Instalar o SteveCAD monousuário ou multiusuário."
${LangFileString} SecFileAssocDescription "Asociar a extensión .FCStd co SteveCAD."
${LangFileString} SecDesktopDescription "Cria un icone do SteveCAD no ambiente de traballo."
...
#${LangFileString} ConfigInfo "A configuración seguinte do SteveCAD irá demorar un pouco."
...
${LangFileString} AlreadyInstalled "O SteveCAD ${APP_SERIES_KEY2} xa está instalado!$\r$\n\
...
#${LangFileString} FinishPageMessage "Parabéns! O SteveCAD foi instalado con suceso.$\r$\n\
#					$\r$\n\
#					(O primeiro início do SteveCAD pode levar alguns segundos.)"
${LangFileString} FinishPageRun "Lanzar o SteveCAD"

${LangFileString} UnNotInRegistryLabel "Non se da achado o SteveCAD no registo.$\r$\n\
					Non se eliminarán os atallos para o ambiente de traballo e no menu de Início."
${LangFileString} UnInstallRunning "Debe fechar o SteveCAD en primeiro lugar!"
${LangFileString} UnNotAdminLabel "Precisa de priviléxios de administrador para desinstalar o SteveCAD!"
${LangFileString} UnReallyRemoveLabel "Seguro que quer eliminar completamente o SteveCAD e todos os seus componentes?"
${LangFileString} UnFreeCADPreferencesTitle 'Preferéncias de usuário do SteveCAD'

#${LangFileString} SecUnProgDescription "Desinstala xxx."
${LangFileString} SecUnPreferencesDescription 'Elimina as pastas de configuración do  SteveCAD$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Desinstala SteveCAD e todos os seus componentes."
