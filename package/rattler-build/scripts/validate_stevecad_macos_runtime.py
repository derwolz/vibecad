...
def _parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run one named SteveCAD macOS runtime validation."
    )
...
def _check_provider_subprocess(prefix: Path) -> None:
    module = _require_bundle_module("SteveCADProvider", prefix)
...
def _check_codex(prefix: Path) -> None:
    module = _require_bundle_module("SteveCADCodex", prefix)
